...
```{r}
cses_isr %>%
  dplyr::select(understands_politics, compromise_betrayal_reversed, dont_care_ppl_reversed, trustworthy, main_problem_reversed, strong_leader, decision_by_ppl_reversed, care_tycoons_reversed, gender, age, education, left_right_scale) %>%
