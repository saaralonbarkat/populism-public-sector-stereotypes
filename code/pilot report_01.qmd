...
```{r}
tmod1 <- lm(morality~populist_attitudes_index_4dim,family="binomial" ,data=responses %>% filter(entity=="civil servants") %>% labelled::remove_labels())
tmod2 <- tmod1 %>% update(.~.+
                            female +
                age_group+
                income+
...
```{r}
tmod1 <- lm(morality~populist_attitudes_index_4dim,family="binomial" ,data=responses %>% filter(entity=="junior civil servants") %>% labelled::remove_labels())
tmod2 <- tmod1 %>% update(.~.+
                            female +
                age_group+
                income+
...
```{r}
tmod1 <- lm(morality~populist_attitudes_index_4dim,family="binomial",data=responses %>% filter(entity=="senior civil servants") %>% labelled::remove_labels())
tmod2 <- tmod1 %>% update(.~.+
                            female +
                age_group+
                income+
